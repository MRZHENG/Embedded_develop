...
#define DMA_PeripheralDataSize_Byte        ((uint32_t)0x00000000)  //1个字节
#define DMA_PeripheralDataSize_HalfWord    ((uint32_t)0x00000100)  //2个字节
#define DMA_PeripheralDataSize_Word        ((uint32_t)0x00000200)  //4个字节
